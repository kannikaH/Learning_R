...
df <- read_csv("C:/Users/kanni/OneDrive/Desktop/Data Analysis/Ex_Files_Learning_R/Ex_Files_Learning_R/Exercise Files/data/state_trends.csv")
...
df2 <- read_excel(
    "C:/Users/kanni/OneDrive/Desktop/Data Analysis/Ex_Files_Learning_R/Ex_Files_Learning_R/Exercise Files/data/state_trends.xlsx", 
    sheet = "all_data"
  ) |>
  as_tibble() |>
  select(state_code, 
